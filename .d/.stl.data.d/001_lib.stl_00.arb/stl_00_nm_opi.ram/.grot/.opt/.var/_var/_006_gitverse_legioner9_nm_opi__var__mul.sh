...
006_gitverse_legioner9_nm_opi__var__mul() {

    echo -e "${CYAN}--- 006_gitverse_legioner9_nm_opi__var__mul() file://${PLT_PATH}/.d/.mul/nm_opi_/var/006_gitverse_legioner9_nm_opi__var__mul.sh ---${NORMAL}" #sistem info mesage
    ...
    clone_net="ssh://git@gitverse.ru:2222/legioner9/${name_repo}.git<>GITVERSE_LEGIONER9_${name_repo}"
    clone_local=
    ...
    push_net_strong="ssh://git@gitverse.ru:2222/legioner9/${name_repo}.git<>GITVERSE_LEGIONER9_${name_repo}"
    push_local_strong="${dir_bare}/${name_repo}<>HOME_REPOBARE_BARE_${name_repo}"

    push_net="git@gitflic.ru:legioner9/${name_repo}.git<>GITFLIC_LEGIONER9_${name_repo}><git@github.com:legioner9/${name_repo}.git<>GITHUB_LEGIONER9_${name_repo}"
