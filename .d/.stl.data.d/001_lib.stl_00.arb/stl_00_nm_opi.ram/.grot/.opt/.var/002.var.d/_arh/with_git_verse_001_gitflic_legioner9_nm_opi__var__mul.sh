...
001_gitflic_legioner9_nm_opi__var__mul() {
    ...
    push_net="git@github.com:legioner9/${name_repo}.git<>GITHUB_LEGIONER9_${name_repo}><ssh://git@gitverse.ru:2222/legioner9/${name_repo}.git<>GITVERSE_LEGIONER9_${name_repo}"
