...
_tst_0f022dd_exec() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/tst/exec.tst
...
if ! _tst_0f022dd_exec  "$@"; then
    l_00_echo_ret1 "EXEC_FAIL for fuction : 'XXX' : GOTO file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/tst : return 1"
    return 1
fi
