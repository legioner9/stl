...
# REPOBARE/_repo/stl/.d/.stl.d/prc.d/boot_stl_fn.d/__dta/l_06_xds71/od.dd/_tst_u_this.sh
echo -e "${CYAN}--- _ord_tst_dir_for_l_xx_rnd7_9caabeb() $* in file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__dta/l_06_xds71/od.dd/_tst_u_this.sh ---${NORMAL}" #started functions
...
_ord_tst_dir_for_NNN_rnd7_95gabyyeb() {
    ...
    local path_file="${STL_D_PATH}/prc.d/boot_stl_fn.d/__dta/l_06_xds71/od.dd/_tst_u_this.sh"
...
${NORMAL}"
    ...
    for item_d in $(l_02_dd2e ${odd_ddr}); do
        od_ddr=${odd_ddr}/$item_d
