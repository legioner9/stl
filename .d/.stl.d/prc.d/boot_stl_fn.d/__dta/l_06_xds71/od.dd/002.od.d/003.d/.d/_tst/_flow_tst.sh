...
_003_ffbe79c_flow() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__dta/l_06_xds71/od.dd/002.od.d/003.d/.d/_tst/_flow_tst.sh
    ...
    unzip opi.d.d.zip
    (l_06_xds71 1 2 opi.d.d/r1.sth2zip_git.d &>/dev/null && echo 0 || echo 1) &>>"${res}"

    cd "${idir}" || {
        l_00_echo_ret1 "${idir} not dir"
        return 1
    }
    cd tst_dir_in || return
    (l_06_xds71 1 2 opi.d.d/r3.sth2zip_git.d &>/dev/null && echo 0 || echo 1) &>>"${res}"
    rm -rf opi.d.d
    #*--------
