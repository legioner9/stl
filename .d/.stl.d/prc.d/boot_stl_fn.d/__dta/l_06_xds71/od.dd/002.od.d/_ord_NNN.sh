...
echo -e "${CYAN}--- _ord_tst_dir_for_l_xx_rnd7_9caabeb() $* in file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__dta/l_04_ix7od/od.d/_ord_NNN.sh ---${NORMAL}" #started functions
...
_ord_tst_dir_for_NNN_rnd7_95gabeb() {
    ...
    local path_file="${STL_D_PATH}/prc.d/boot_stl_fn.d/__dta/l_04_ix7od/od.d/_ord_NNN.sh"
