...
echo -e "${CYAN}--- _ord_file_with_l_xx_rnd7_6775dea() $* in file://${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/_ord_file_with_l_xx_2.sh ---${NORMAL}" #started functions
...
_ord_file_with_l_xx_rnd7_6775dea() {
    ...
    local path_file="${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/_ord_file_with_l_xx_2.sh"
