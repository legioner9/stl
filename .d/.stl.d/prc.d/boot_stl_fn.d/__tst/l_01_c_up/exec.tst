...
_l_01_c_up_bf9992a_exec() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_01_c_up/exec.tst
...
if ! _l_01_c_up_bf9992a_exec  "$@"; then
    l_00_echo_ret1 "EXEC_FAIL for fuction : 'XXX' : GOTO file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_01_c_up : return 1"
    return 1
fi
