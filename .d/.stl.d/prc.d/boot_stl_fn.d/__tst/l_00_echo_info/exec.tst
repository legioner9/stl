...
__l_00_echo_info() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/_l_00_echo_info/exec.tst
...
if ! __l_00_echo_info "$@"; then
    l_00_echo_ret1 "EXEC_FAIL for fuction : 'l_00_echo_info' : GOTO file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/_l_00_echo_info : return 1"
    return 1
fi
