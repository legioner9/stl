...
_l_02_unzip2_711cb95_flow_1() {

    if ! command -v l_02_unzip2 >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_02_unzip2"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_unzip2/_flow_tst_v1.sh
    ...
    cat dir_src/file_src
    echo
    cat dir_src/dir_src_in/file_src_in
    echo
