...
_l_02_ixfv_RND_flow_1() {

    unset IFS

    if ! command -v l_02_ixfv >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_02_ixfv"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_ixfv/_flow_tst_v1.sh
