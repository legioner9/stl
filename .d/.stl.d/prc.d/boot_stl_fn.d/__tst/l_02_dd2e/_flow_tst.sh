...
_l_02_dd2e_a14cfe5_flow() {

    if ! command -v l_02_dd2e >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_02_dd2e"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_dd2e/_flow_tst.sh
    ...
    l_02_dd2e d2 yes &>>"${res}"

    # l_02_dd2e "${tst_dir}" &>>"${res}"
