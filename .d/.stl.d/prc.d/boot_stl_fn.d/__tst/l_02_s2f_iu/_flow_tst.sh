...
_l_02_s2f_iu_RND_flow() {
    ...
    if ! command -v l_02_s2f_iu >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_02_s2f_iu"
        cd $PW
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_s2f_iu/_flow_tst.sh
    ...
    #     echo "FILE_ARG:"
    #     l_02_s2f_iu FILE &>>"${res}"

    #     echo "FILE_PIPE:"
    #     cat FILE | l_02_s2f_iu &>>"${res}"
    ...
    #     echo "HERE_STR:"
    #     l_02_s2f_iu <<<"here_str_::_fifth_str" &>>"${res}"
