...
_005_c76c177_exec() {
    ...
    #     l_00_echo_ret1 "TYPE_ERROR : 005" >&2
    #     return 1
    # fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_03_ixod/tst_dir/_dir_/005.d/.d/_tst/exec_n.tst
    local idir="$(dirname ${filename})"

    l_00_echo_info "test function 005 in file://${filename}"
