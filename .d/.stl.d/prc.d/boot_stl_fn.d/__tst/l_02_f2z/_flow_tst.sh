...
_l_02_f2z_3b8854c_flow() {

    if ! command -v l_02_f2z >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_02_f2z"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_f2z/_flow_tst.sh
    ...
    l_02_f2z 208_b_file.px &>"${res}"

    # l_02_f2z "${tst_dir}" &>"${res}"
