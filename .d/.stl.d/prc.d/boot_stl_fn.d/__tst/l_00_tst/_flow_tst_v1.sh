...
_l_00_tst_RND_flow_1() {

    if ! command -v l_00_tst >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_00_tst"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_00_tst/_flow_tst_v1.sh
