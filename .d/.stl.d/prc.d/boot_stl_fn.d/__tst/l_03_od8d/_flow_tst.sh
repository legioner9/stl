...
_l_03_od8d_RND_flow() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_03_od8d/_flow_tst.sh
    ...
    local res_546h3448h66=

    # l_03_od8d _dir_ res_546h3448h66 "0"
    # echo ${res_546h3448h66}
    l_03_od8d _dir_ res_546h3448h66 "2"
    echo ${res_546h3448h66} &>>"${res}"
    l_03_od8d _dir_ res_546h3448h66 @ <<<"3"
    echo ${res_546h3448h66} &>>"${res}"
