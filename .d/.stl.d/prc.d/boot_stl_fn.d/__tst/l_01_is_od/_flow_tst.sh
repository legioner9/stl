...
_l_01_is_od_9e036f0_flow() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_01_is_od/_flow_tst.sh
    ...
    (l_01_is_od "23" && echo 0 || echo 1) &>>"${res}"
    (l_01_is_od "2w3" && echo 0 || echo 1) &>>"${res}"
