...
_l_01_dr2e_74e9736_flow() {

    if ! command -v l_01_dr2e >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_01_dr2e"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_01_dr2e/_flow_tst.sh
    ...
    l_01_dr2e d2 yes &>"${res}"

    # l_01_dr2e "${tst_dir}" &>"${res}"
