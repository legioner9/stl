...
_l_00_echo_exec_569320a_exec() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_00_echo_exec/exec.tst
...
if ! _l_00_echo_exec_569320a_exec  "$@"; then
    l_00_echo_ret1 "EXEC_FAIL for fuction : 'XXX' : GOTO file://${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_00_echo_exec : return 1"
    return 1
fi
