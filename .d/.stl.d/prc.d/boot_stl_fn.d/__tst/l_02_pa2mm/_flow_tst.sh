...
_l_02_pa2mm_26e1a86_flow() {
    ...
    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_02_pa2mm/_flow_tst.sh
    ...
    l_00_echo_code "'l_02_pa2mm nm_arr re_arr re 2'" &>>"${res}"
    l_02_pa2mm nm_arr re_arr re 2 &>>"${res}"

    l_00_echo_info "'\$re = $re'" &>>"${res}"
    re=
    l_00_echo_code "'l_02_pa2mm nm_arr re_arr re 3'" &>>"${res}"
