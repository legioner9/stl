...
_l_03_zbcpl_RND_flow_1() {

    if ! command -v l_03_zbcpl >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_03_zbcpl"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_03_zbcpl/_flow_tst_v1.sh
