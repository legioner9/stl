...
_l_04_od7xfv_3df7741_flow() {
    ...
    if ! command -v l_04_od7xfv >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_04_od7xfv"
        cd $PW
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_04_od7xfv/_flow_tst.sh
    ...
    #     echo "FILE_ARG:"
    #     l_04_od7xfv FILE &>>"${res}"

    #     echo "FILE_PIPE:"
    #     cat FILE | l_04_od7xfv &>>"${res}"
