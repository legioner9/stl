...
echo -e "${CYAN}--- _rbld_l_xx_rnd7_57530e2() $* in file://${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/_rbld_l_xx_2.sh ---${NORMAL}" #started functions

_rbld_l_xx_rnd7_57530e22() {
    ...
    local path_file="${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/_rbld_l_xx_2.sh"
...
${NORMAL}"
    ...
    if ! cat ${fn_dir}/${fn_name}.sh | grep {{fn_body}}; then
        ...
        . _ord_file_with_l_xx_2.sh ${fn_name}
        # else
        #     return 1
        # fi
    fi
