...
l_04_glf_tdf4f() {
    ...
    #! THIS FILE WILL BE CREATED: `. ${STL_D_PATH}/prc.d/boot_stl_fn.d/_rbld_l_xx.sh l_04_glf_tdf4f`
    #! All changes will be lost after rebuilding
    #! To change this file use the following commands:

    #! l_04_glf_tdf4f _e_prc to edit/change 'fn block',
    #! l_04_glf_tdf4f _rbld to rebuild fn with changed 'fn block'
    #! l_04_glf_tdf4f _e_xxx` to edit 'init block'
    ...
    if [[ "_rbld" == "$1" ]]; then
        #! rebuild fn : bcp && ord fn.sh from l_04_glf_tdf4f.sh , cp fn.prc into fn.sh
    ...
    #* START fn block from from ${STL_D_PATH}/prc.d/boot_stl_fn.d/__prc/l_04_glf_tdf4f.prc ------------------
    #[[fn_body]]
