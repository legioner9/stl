...
tst() {
    ...
    #! THIS FILE WILL BE CREATED `. ${STL_D_PATH}/prc.d/boot_stl_fn.d/_rbld_l_xx.sh tst`
    #! All changes will be lost after rebuilding
    #! To change this file use the following commands `tst _e_prc` to edit "fn block", `tst _e_xxx` to edit "init block"
    ...
    #* START fn block from from ${STL_D_PATH}/prc.d/boot_stl_fn.d/__prc/tst.prc ------------------
    #[[fn_body]]
