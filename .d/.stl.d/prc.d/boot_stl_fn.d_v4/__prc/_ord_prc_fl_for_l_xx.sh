...
echo -e "${CYAN}--- _ord_prc_fl_for_l_xx_rnd7_5a6e6f0() $* in file://${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/__prc/_ord_prc_fl_for_l_xx.sh ---${NORMAL}" #started functions
...
_ord_prc_fl_for_l_xx_rnd7_5a6e6f0() {
    ...
    local path_file="${REPO_PATH}/stl/.d/.stl.d/prc.d/boot_stl_fn.d/__prc/_ord_prc_fl_for_l_xx.sh"
...
${NORMAL}"
    ...
    local prc_dir=${STL_D_PATH}/prc.d/boot_stl_fn.d/__prc
    ...
    _is_yes "ord _${fn_name} in ${prc_dir}?" && {
        ...
        _sf2f XXX ${fn_name} ${prc_dir}/_XXX.prc || {
