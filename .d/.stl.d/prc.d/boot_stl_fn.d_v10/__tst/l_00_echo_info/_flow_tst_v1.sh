...
_l_00_echo_info_e1d1e32_flow_1() {

    if ! command -v l_00_echo_info >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_00_echo_info"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_00_echo_info/_flow_tst_v1.sh
