...
_l_00_echo_exec_569320a_flow_1() {

    if ! command -v l_00_echo_exec >/dev/null; then
        l_00_echo_ret1 "TYPE_ERROR : l_00_echo_exec"
        return 1
    fi

    local filename=${STL_D_PATH}/prc.d/boot_stl_fn.d/__tst/l_00_echo_exec/_flow_tst_v1.sh
