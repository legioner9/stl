...
___XXX_YYY_TST() {
    ...
    local filename=${ST_RC_D_PATH}/.d/.arb/stl0.arb/_XXX_YYY.ram/.grot/_tst/exec.tst
...
if ! ___XXX_YYY_TST "$@"; then
    _st_exit "in fs= file://${ST_RC_D_PATH}/.d/.arb/stl0.arb/_XXX_YYY.ram/.grot/_tst/exec._tst , line=${LINENO}: : EXEC_FAIL : '___XXX_YYY_TST ' : ${hint} : return 1"
    return 1
fi
