...
echo -e "${CYAN}--- _rm_name_prc_ram_rnd7_b9a3674() $* in file://${REPO_PATH}/stl/.d/.stl.lib.d/001_lib.stl_00.arb/_rm_name_prc_ram.sh ---${NORMAL}" #started functions
...
_rm_name_prc_ram_rnd7_b9a3674() {
    ...
    local path_file="${REPO_PATH}/stl/.d/.stl.lib.d/001_lib.stl_00.arb/_rm_name_prc_ram.sh"
