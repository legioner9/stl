...
filename="${STL_LIB_D_PATH}/{{lib_name_dir_arb}}/stl_00_tst.ram/.grot/stl_00_tst.prc"
...
stl_00_tst() {
    ...
    #* local opt_dir=${STL_DATA_D_PATH}/data.stl_00.arb/stl_00_tst.ram/.grot/.opt
    #* local depo_dir=${STL_DATA_D_PATH}/data.stl_00.arb/stl_00_tst.ram/.grot/.depo

    local fn_sh_grot=${STL_LIB_D_PATH}/{{lib_name_dir_arb}}/stl_00_tst.ram/.grot

    local fn_sh_file="${fn_sh_grot}/stl_00_tst.prc"
    local fn_hie_file="${fn_sh_grot}/stl_00_tst.hie"
