...
filename="${ST_RC_D_PATH}/.d/.arb/stl0.arb/tst_0stl.ram/.grot/tst_0stl.sh"
...
tst_0stl() {
    ...
    #* local fn_data_dir=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/tst_0stl

    local fn_sh_file=${ST_RC_D_PATH}/.d/.arb/stl0.arb/tst_0stl.ram/.grot/tst_0stl.sh
    local fn_hie_file=${ST_RC_D_PATH}/.d/.arb/stl0.arb/tst_0stl.ram/.grot/tst_0stl.hie
    local d_name=$(dirname ${fn_sh_file})

    local usr_fn_data_dir=${ST_RC_D_DATA_PATH}/.d/.st_rc_d.data.d/tst_0stl
