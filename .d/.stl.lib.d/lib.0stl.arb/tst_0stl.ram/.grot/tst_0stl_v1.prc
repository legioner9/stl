...
filename="${STL_LIB_D_PATH}/lib.0stl.arb/tst_0stl.ram/.grot/tst_0stl.prc"
...
tst_0stl() {
    ...
    #* local opt_dir=${STL_DATA_D_PATH}/data.0stl.arb/tst_0stl.ram/.grot/.opt
    #* local depo_dir=${STL_DATA_D_PATH}/data.0stl.arb/tst_0stl.ram/.grot/.depo

    local fn_sh_grot=${STL_LIB_D_PATH}/lib.0stl.arb/tst_0stl.ram/.grot

    local fn_sh_file="${fn_sh_grot}/tst_0stl.prc"
    local fn_hie_file="${fn_sh_grot}/tst_0stl.hie"
