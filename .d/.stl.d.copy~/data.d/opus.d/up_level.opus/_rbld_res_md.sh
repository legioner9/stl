...
echo -e "${CYAN}--- _rbld_res_md_rnd7_e852ee6() $* in file://${HOME}/.stl.d/data.d/opus.d/up_level.opus/_rbld_res_md.sh ---${NORMAL}" #started functions

_rbld_res_md_rnd7_e852ee6() {
    ...
    local NARGS=$#
    local PPWD=$PWD
    local path_file="${HOME}/.stl.d/data.d/opus.d/up_level.opus/_rbld_res_md.sh"
